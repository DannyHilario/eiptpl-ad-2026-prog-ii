...
Registro del primer piso, con dos datos fuera de rango:
...
Después de registrar los 4 pisos de los casos de prueba:
...
Disponible: 2 (50%)
Lleno: 2 (50%)
Promedio de ocupacion del estacionamiento: 90.25%
```
